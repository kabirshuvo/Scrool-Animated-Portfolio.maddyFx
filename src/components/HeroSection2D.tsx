...
const HeroSection2D = () => {
  ...
  return (
    ...
    >
      <div className="w-full md:w-[70%]  md:text-right flex flex-wrap flex-col justify-center items-center text-right p-8">
        <div className="text-7xl md:text-[7rem] my-7 text-[#f2994a]">
          <h1 className="font-extrabold text-right ">I came I saw I won</h1>
        </div>
        <p className="text-base md:text-lg ms-7">
